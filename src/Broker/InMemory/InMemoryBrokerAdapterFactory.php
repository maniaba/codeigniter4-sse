...
final readonly class InMemoryBrokerAdapterFactory implements BrokerAdapterFactoryInterface
{
    public function create(Sse $config, BrokerBuildContext $context): BrokerAdapterInterface
    {
        return (new LocalBrokerAdapterFactory(InMemoryBroker::class))->create($config, $context);
    }
}
